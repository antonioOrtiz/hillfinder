...
class RegisterForm extends Component {
    ...
    */
            ...
            textAlign = 'center' >
            Register
            for an account { /* {isLoggedIn ? `Register for an account` : ` Log-in to your account`} */ } <
            /Header>

            { console.log("formSuccess 1", formSuccess) } <
            Form size = 'large'
            onSubmit = { this.handleSubmit }
            error = { userNameDup || formError } > { console.log("formSuccess 2", formSuccess) }
